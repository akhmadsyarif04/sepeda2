			...
			<div class="col-md-9 product1">
			    ...
			    $pages = ceil($total / $perpage);
					?>
	  				...
	  				<a href="tambah.php" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
			        <thead>
			          <tr>
			              <th data-field="id">Foto</th>
			              <th data-field="name">Nama Sepeda</th>
			              <th data-field="price">Merek</th>
					...
					<div class="col-md-6 bottom-cd simpleCart_shelfItem">
						<tbody>
							<tr>
								...
								<td><?= $hasil['nama_sepeda']; ?></td>
								<td><?= $hasil['merek']; ?></td>
								<td><?= $hasil['size_sepeda']; ?></td>
								<td><?= $hasil['jumlah_barang']; ?></td>
								<td>Rp.<?= number_format($uang, $jlh_desimal, $pemisah_desimal, $pemisah_ribuan);  ?></td>
								<td><a href="edit.php?kode_sepeda=<?= $hasil['kode_sepeda']; ?>"><i class="material-icons">mode_edit</i></a></td>
								<td><a href="hapus.php?kode_sepeda=<?= $hasil['kode_sepeda']; ?>"><i class="material-icons">delete</i></a></td>
							</tr>
						<div class="clearfix"></div>
					</div>
					<?php
