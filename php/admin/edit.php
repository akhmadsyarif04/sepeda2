	...
	<div class="pro-du">
		<div class="container">
          ...
          <table border="0" style="font-size:1.5em; color:#8b8585;">
					<?php
					$kode_edit = $_GET['kode_sepeda'];
			    $isi = "SELECT * FROM sepeda WHERE kode_sepeda LIKE '%$kode_edit%' ";
			        ...
			        while ($hasil = $result2->fetch_assoc()) {
			            ...
			            ?>
							        ...
							        <div class="input-field col s12">
							          <input name="nama_sepeda" type="text" class="validate" value="<?= $hasil['nama_sepeda'] ?>">
							          <label style="font-size:1em;">Nama Sepeda</label>
							        </div>
							      </div>
										<div class="row">
							        <div class="input-field col s12">
							          <input name="merek_sepeda" type="text" class="validate" value="<?= $hasil['merek'] ?>">
							          <label style="font-size:1em;">Merek Sepeda</label>
							        </div>
							      </div>
										<div class="row">
							        <div class="input-field col s12">
							          <input name="harga_sepeda" type="text" class="validate" value="<?= $hasil['harga_sepeda'] ?>">
							          <label style="font-size:1em;">Harga Sepeda</label>
							        </div>
							      </div>
										<label style="font-size:1em;">Size Sepeda</label>
										<select name="size_sepeda" class="browser-default">
																	<option value="<?= ['nama_sepeda'] ?>"><?= $hasil['size_sepeda'] ?></option>
										...
										<div class="row">
							        <div class="input-field col s12">
							          <input name="jumlah_sepeda" type="text" class="validate" value="<?= $hasil['jumlah_barang'] ?>">
							          <label style="font-size:1em;">Jumlah Sepeda</label>
							        </div>
							      </div>
