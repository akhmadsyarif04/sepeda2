		...
		<div class="container">
          ...
          <table border="0" style="font-size:1.5em; color:#8b8585;">
							        ...
							        <div class="input-field col s12">
							          <input name="nama_sepeda" type="text" class="validate">
							          <label style="font-size:1em;">Nama Sepeda</label>
							        </div>
							      </div>
										<div class="row">
							        <div class="input-field col s12">
							          <input name="merek_sepeda" type="text" class="validate">
							          <label style="font-size:1em;">Merek Sepeda</label>
							        </div>
							      </div>
										<div class="row">
							        <div class="input-field col s12">
							          <input name="harga_sepeda" type="text" class="validate">
							          <label style="font-size:1em;">Harga Sepeda</label>
										...
										<div class="row">
							        <div class="input-field col s12">
							          <input name="jumlah_sepeda" type="text" class="validate">
