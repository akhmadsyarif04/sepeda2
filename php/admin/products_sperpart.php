		...
		<div class="container">
			<div class="col-md-9 product1">
			    ...
			    $pages = ceil($total / $perpage);
					...
					<a href="tambah_sperpart.php" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
						<thead>
							<tr>
									<th data-field="id">Foto</th>
									<th data-field="name">Nama Sperpart</th>
									<th data-field="price">Jenis</th>
									<th data-field="price">Jumlah<br>Barang</th>
			        ...
			        while ($hasil = $result2->fetch_assoc()) {
			            ...
			            ?>
									<div class="col-md-6 bottom-cd simpleCart_shelfItem">
										<tbody>
											<tr>
												<td><img src="../../gambar_sepeda/<?= $hasil['gambar']; ?>" width="70%" height="50px"></td>
												<td><?= $hasil['nama_sperpart']; ?></td>
												<td><?= $hasil['jenis']; ?></td>
												<td><?= $hasil['jumlah_barang']; ?></td>
												<td>Rp.<?= number_format($uang, $jlh_desimal, $pemisah_desimal, $pemisah_ribuan);  ?></td>
												<td><a href="edit_sperpart.php?kode_sperpart=<?= $hasil['id_sperpart']; ?>"><i class="material-icons">mode_edit</i></a></td>
												<td><a href="hapus_sperpart.php?kode_sperpart=<?= $hasil['id_sperpart']; ?>"><i class="material-icons">delete</i></a></td>
											</tr>
										<div class="clearfix"></div>
									</div>
					<?php
