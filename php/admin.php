		...
		<div class="cont">
			<div class="content">
				<div class="content-top-bottom">
					...
					<?php
					$isi = "SELECT * FROM sepeda WHERE nama_sepeda LIKE '%ricochet%' LIMIT 1";
					$result2 = $db->query($isi);
					$no = 1;
					while ($hasil = $result2->fetch_assoc()) {
					?>
					<div class="col-md-6 men">
						<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="gambar_sepeda/<?= $hasil['gambar'];?>" alt="">
							<div class="b-wrapper">
												<h3 class="b-animate b-from-top top-in   b-delay03 ">
													<span><?= $hasil['nama_sepeda']; ?></span>
												</h3>
											</div>
						</a>
					...
					$isi = "SELECT * FROM sepeda WHERE nama_sepeda LIKE '%xtrada%' LIMIT 1";
					$result2 = $db->query($isi);
					$no = 1;
					while ($hasil = $result2->fetch_assoc()) {
					?>
			...
			<p><a href="single.html"><?= $hasil['nama_sepeda']; ?></a></p>
