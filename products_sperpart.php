			    ...
			    $pages = ceil($total / $perpage);
					...
					<div class="col-md-6 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="single_sperpart.php?kode=<?= $hasil['id_sperpart']; ?>"><img class="img-responsive" src="gambar_sepeda/<?= $hasil['gambar']; ?>" alt="">
						</a>
						</div>
						<p class="tun"><span><?= $hasil['jenis']; ?></span><br><?= $hasil['nama_sperpart']; ?></p>
						<div class="ca-rt">
